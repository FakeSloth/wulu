  ...
  var commands = {
    ...
    define: function define(target, room) {
      if (!this.canBroadcast()) {
        ...
        return this.sendReply('/define [word] - Shows the definition of a word.');
      }target = toId(target);
      if (target.length > 50) {
      ...
      _request2['default'](options, callback);
    },
    ...
    urbandefine: function urbandefine(target, room) {
      if (!this.canBroadcast()) {
        ...
        return this.sendReply('/urbandefine [word] - Finds the urban definition of the word.');
      }if (target.length > 50) {
        return this.sendReply('Phrase can not be longer than 50 characters.');
      }var self = this;
      var options = {
